            ...
            <div className="flex flex-wrap gap-2">
              {recentSearches.map((zipCode) => (
                <button
                  ...
                  className="px-4 py-2 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-full hover:bg-zinc-50 dark:hover:bg-zinc-700 hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors text-sm text-zinc-900 dark:text-zinc-100"
                >
                  {zipCode}
                </button>
              ))}
